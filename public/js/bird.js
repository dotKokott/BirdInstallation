...
function Bird(x, y, yOff, base, offset1, offset2) {
    this.rot = 0;
...
Bird.prototype.setRot = function(p, rot) {
    this.rot = p.radians(rot);
}

Bird.prototype.addRot = function(p, rot) {
    this.rot += p.radians(rot);
}

Bird.prototype.draw = function(p, fillColor, strokeColor) {
